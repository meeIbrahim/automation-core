Feature: Enable/Disable AWS Hosted Service Connector
  As a user I would like to test all Scenarios of Enabling and Disabling AWS Hosted Service Connector
