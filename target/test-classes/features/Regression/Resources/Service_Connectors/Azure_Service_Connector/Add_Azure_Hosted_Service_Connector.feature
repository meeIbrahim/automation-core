Feature: Add Azure Hosted Service Connector
  As a user I would like to test all Scenarios of Adding Azure Hosted Service Connector

    @scenario-1
  Scenario: Verify that Service Connector is added
      Given Relay A is active
      Given azure-integration A is active
      When user adds azure site A with relay A and integration A
      Then Site A should be added
      When User configures azure service connector A with site A
